...
@Slf4j
@Component(value = "ConvertMinutesToHours")
public class ConvertMinutesToHours implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            minutes = (Double) attributes.get("minutes");
            ...
            log.error("NLP_EXCEPTION in ConvertMinutesToHours ", exception);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("	Double hours = minutes / 60;\n");
