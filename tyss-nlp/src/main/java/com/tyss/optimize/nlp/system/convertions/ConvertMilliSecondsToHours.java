...
@Slf4j
@Component(value = "ConvertMillisSecondsToHours")
public class ConvertMilliSecondsToHours implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            Double hours = milliSeconds / (60 * 60 * 1000);
            ...
            log.error("NLP_EXCEPTION in ConvertMillisSecondsToHours ", exception);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("	Double hours = milliSeconds / (60 * 60 * 1000);\n");
