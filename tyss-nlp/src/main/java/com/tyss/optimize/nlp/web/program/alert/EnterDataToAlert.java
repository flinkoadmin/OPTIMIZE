...
public class EnterDataToAlert implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            nlpResponseModel= ExceptionHandlingInfo.exceptionMessageHandler(failMessage.replace("*message*",message), ifCheckPointIsFailed, exceptionSimpleName, exception.getStackTrace());
            if(containsChildNlp) {
