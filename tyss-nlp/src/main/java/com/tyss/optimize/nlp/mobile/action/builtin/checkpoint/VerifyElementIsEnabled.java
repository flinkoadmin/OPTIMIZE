...
@Slf4j
@Component(value = "MOB_VerifyElementIsEnabled")
public class VerifyElementIsEnabled implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            while (retry) {
                count++;
                Boolean actualEnabledStatus = (Boolean) ((NlpResponseModel) new IsEnabled().execute(nlpRequestModel)).getAttributes().get("status");
