...
public class VerifyIfOptionWithIndexIsDeselectedInElement implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        Boolean optionWithIndexIsDeselected = false;
        ...
        try {
            ...
            if (index < allOptions.size()) {
                ...
                if (!option.isSelected()) {
                    ...
                    optionWithIndexIsDeselected = true;
                ...
                nlpResponseModel.setIfCheckPointIsFailed(ifCheckPointIsFailed);
                nlpResponseModel.setMessage("Invalid index is provided");
                nlpResponseModel.setStatus(CommonConstants.fail);
            }
        ...
        nlpResponseModel.getAttributes().put("optionWithIndexIsDeselected", optionWithIndexIsDeselected);
