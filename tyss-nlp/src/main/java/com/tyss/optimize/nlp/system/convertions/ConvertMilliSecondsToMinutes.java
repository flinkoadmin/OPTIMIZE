...
@Slf4j
@Component(value = "ConvertMilliSecondsToMinutes")
public class ConvertMilliSecondsToMinutes implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            milliSeconds = (Double) attributes.get("milliseconds");
            Double minutes = milliSeconds / (60 * 1000);
            ...
            log.error("NLP_EXCEPTION in ConvertMilliSecondsToMinutes ", exception);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("	Double minutes = milliSeconds / (60 * 1000);\n");
