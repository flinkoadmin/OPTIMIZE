...
public class VerifyValueOfElementContainsString implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        Boolean elementValueContainsString = false;
        ...
        try {
            ...
            if (match) {
                ...
                elementValueContainsString = true;
        ...
        nlpResponseModel.getAttributes().put("elementValueContainsString", elementValueContainsString);
