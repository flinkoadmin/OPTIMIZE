...
public class SetBrowserWindowWidth implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            nlpResponseModel= ExceptionHandlingInfo.exceptionMessageHandler(failMessage.replace("*width*", width.toString()), ifCheckPointIsFailed, exceptionSimpleName, exception.getStackTrace());
            if(containsChildNlp) {
