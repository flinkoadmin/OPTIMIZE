...
@Slf4j
@Component(value = "VerifyAlertPopUpMessageContainsString")
public class VerifyAlertPopUpMessageContainsString implements Nlp {
    @Override
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        Boolean alertPopupContainsMessage = false;
        try {
            ...
            if (actualText.contains(string)) {
                ...
                alertPopupContainsMessage = true;
        ...
        nlpResponseModel.getAttributes().put("alertPopupContainsMessage",alertPopupContainsMessage);
