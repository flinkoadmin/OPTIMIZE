...
@Slf4j
@Component(value = "VerifyElementIsEnabled")
public class VerifyElementIsEnabled implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            if (match) {
                ...
                log.error(elementName + " " + elementType + " is not enabled");
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("}\n");
        sb.append("if (match) {\n");
        sb.append("	System.out.println(\"The Element is enabled\");\n");
        sb.append("} else {\n");
        sb.append("	System.out.println(\"The Element is not enabled\");\n");
        sb.append("}\n");
