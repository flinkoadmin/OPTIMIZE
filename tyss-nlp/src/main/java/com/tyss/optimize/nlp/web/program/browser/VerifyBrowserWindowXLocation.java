...
public class VerifyBrowserWindowXLocation implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            Integer actualXLocation = webDriver.manage().window().getPosition().getX();
            modifiedFailMessage = failMessage.replace("*expectedLocation*", expectedLocation.toString()).replace("*actualLocation*", actualXLocation.toString());
            if (actualXLocation == expectedLocation) {
        ...
        nlpResponseModel.getAttributes().put("actualXLocation", xLocation);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("int actualXLocation = webDriver.manage().window().getPosition().getX();\n");
        sb.append("if (actualXLocation == expectedLocation) {\n");
        sb.append("	System.out.println(\"X coordinate of browser window is  \" + expectedLocation + \");\n");
        sb.append("} else {\n");
        sb.append("	System.out.println(\"Browser window X coordinate is is not \" + expectedLocation + \". The actual X coordinate is \" +actualXLocation + \");\n");
        sb.append("}\n");
