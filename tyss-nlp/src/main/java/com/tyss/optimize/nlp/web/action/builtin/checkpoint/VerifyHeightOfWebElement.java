...
public class VerifyHeightOfWebElement implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        Boolean heightOfWebElement = false;
        ...
        try {
            ...
            modifiedFailMessage = failMessage.replace("*elementName*", elementName)
                    ...
                    replace("*expectedHeight*", String.valueOf(expectedHeight)).replace("*integer*", String.valueOf(actualHeight));
            if (actualHeight == expectedHeight) {
                log.info("The height of " + elementName + " " + elementType + " is " + actualHeight);
                heightOfWebElement = true;
                nlpResponseModel.setMessage(modifiedPassMessage);
                nlpResponseModel.setStatus(CommonConstants.pass);
            } else {
                log.error("The height of " + elementName + " " + elementType + " is not " + actualHeight);
        ...
        nlpResponseModel.getAttributes().put("heightOfWebElement", heightOfWebElement);
