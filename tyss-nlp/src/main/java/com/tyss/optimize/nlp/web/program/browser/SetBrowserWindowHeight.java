...
public class SetBrowserWindowHeight implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            nlpResponseModel= ExceptionHandlingInfo.exceptionMessageHandler(failMessage.replace("*height*", height.toString()), ifCheckPointIsFailed, exceptionSimpleName, exception.getStackTrace());
            if(containsChildNlp) {
