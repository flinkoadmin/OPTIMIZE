...
public class VerifyBrowserWindowWidth implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            int actualWidth = webDriver.manage().window().getSize().getWidth();
            modifiedFailMessage = failMessage.replace("*expectedWidth*", String.valueOf(expectedWidth)).replace("*actualWidth*", String.valueOf(actualWidth));
        ...
        nlpResponseModel.getAttributes().put("windowWidth", windowWidth);
